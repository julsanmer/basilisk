...
class VizMessage_CameraConfig final :
 ...
 public:
  ...
  enum : int {
    ...
    kDepthMapClippingPlanesFieldNumber = 17,
  ...
  int depthmapclippingplanes_size() const;
  private:
  int _internal_depthmapclippingplanes_size() const;
  public:
  void clear_depthmapclippingplanes();
  private:
  double _internal_depthmapclippingplanes(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
      _internal_depthmapclippingplanes() const;
  void _internal_add_depthmapclippingplanes(double value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
      _internal_mutable_depthmapclippingplanes();
  public:
  double depthmapclippingplanes(int index) const;
  void set_depthmapclippingplanes(int index, double value);
  void add_depthmapclippingplanes(double value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
      depthmapclippingplanes() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
      mutable_depthmapclippingplanes();
  ...
  ::PROTOBUF_NAMESPACE_ID::int64 rendermode() const;
  void set_rendermode(::PROTOBUF_NAMESPACE_ID::int64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_rendermode() const;
  void _internal_set_rendermode(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< double > depthmapclippingplanes_;
  ...
  ::PROTOBUF_NAMESPACE_ID::int64 rendermode_;
...
class VizMessage_VizSettingsPb final :
 ...
 public:
  ...
  enum : int {
    ...
    kUseSimpleLocationMarkersFieldNumber = 51,
  };
  ...
  void clear_usesimplelocationmarkers();
  ::PROTOBUF_NAMESPACE_ID::int32 usesimplelocationmarkers() const;
  void set_usesimplelocationmarkers(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_usesimplelocationmarkers() const;
  void _internal_set_usesimplelocationmarkers(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 usesimplelocationmarkers_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_vizMessage_2eproto;
};
// -------------------------------------------------------------------
...
// int64 renderMode = 16;
inline void VizMessage_CameraConfig::clear_rendermode() {
  rendermode_ = int64_t{0};
}
inline ::PROTOBUF_NAMESPACE_ID::int64 VizMessage_CameraConfig::_internal_rendermode() const {
  return rendermode_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 VizMessage_CameraConfig::rendermode() const {
  // @@protoc_insertion_point(field_get:vizProtobufferMessage.VizMessage.CameraConfig.renderMode)
  return _internal_rendermode();
}
inline void VizMessage_CameraConfig::_internal_set_rendermode(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  rendermode_ = value;
}
inline void VizMessage_CameraConfig::set_rendermode(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_rendermode(value);
  // @@protoc_insertion_point(field_set:vizProtobufferMessage.VizMessage.CameraConfig.renderMode)
}

// repeated double depthMapClippingPlanes = 17;
inline int VizMessage_CameraConfig::_internal_depthmapclippingplanes_size() const {
  return depthmapclippingplanes_.size();
}
inline int VizMessage_CameraConfig::depthmapclippingplanes_size() const {
  return _internal_depthmapclippingplanes_size();
}
inline void VizMessage_CameraConfig::clear_depthmapclippingplanes() {
  depthmapclippingplanes_.Clear();
}
inline double VizMessage_CameraConfig::_internal_depthmapclippingplanes(int index) const {
  return depthmapclippingplanes_.Get(index);
}
inline double VizMessage_CameraConfig::depthmapclippingplanes(int index) const {
  // @@protoc_insertion_point(field_get:vizProtobufferMessage.VizMessage.CameraConfig.depthMapClippingPlanes)
  return _internal_depthmapclippingplanes(index);
}
inline void VizMessage_CameraConfig::set_depthmapclippingplanes(int index, double value) {
  depthmapclippingplanes_.Set(index, value);
  // @@protoc_insertion_point(field_set:vizProtobufferMessage.VizMessage.CameraConfig.depthMapClippingPlanes)
}
inline void VizMessage_CameraConfig::_internal_add_depthmapclippingplanes(double value) {
  depthmapclippingplanes_.Add(value);
}
inline void VizMessage_CameraConfig::add_depthmapclippingplanes(double value) {
  _internal_add_depthmapclippingplanes(value);
  // @@protoc_insertion_point(field_add:vizProtobufferMessage.VizMessage.CameraConfig.depthMapClippingPlanes)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
VizMessage_CameraConfig::_internal_depthmapclippingplanes() const {
  return depthmapclippingplanes_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
VizMessage_CameraConfig::depthmapclippingplanes() const {
  // @@protoc_insertion_point(field_list:vizProtobufferMessage.VizMessage.CameraConfig.depthMapClippingPlanes)
  return _internal_depthmapclippingplanes();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
VizMessage_CameraConfig::_internal_mutable_depthmapclippingplanes() {
  return &depthmapclippingplanes_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
VizMessage_CameraConfig::mutable_depthmapclippingplanes() {
  // @@protoc_insertion_point(field_mutable_list:vizProtobufferMessage.VizMessage.CameraConfig.depthMapClippingPlanes)
  return _internal_mutable_depthmapclippingplanes();
}
...
// int32 useSimpleLocationMarkers = 51;
inline void VizMessage_VizSettingsPb::clear_usesimplelocationmarkers() {
  usesimplelocationmarkers_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 VizMessage_VizSettingsPb::_internal_usesimplelocationmarkers() const {
  return usesimplelocationmarkers_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 VizMessage_VizSettingsPb::usesimplelocationmarkers() const {
  // @@protoc_insertion_point(field_get:vizProtobufferMessage.VizMessage.VizSettingsPb.useSimpleLocationMarkers)
  return _internal_usesimplelocationmarkers();
}
inline void VizMessage_VizSettingsPb::_internal_set_usesimplelocationmarkers(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  usesimplelocationmarkers_ = value;
}
inline void VizMessage_VizSettingsPb::set_usesimplelocationmarkers(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_usesimplelocationmarkers(value);
  // @@protoc_insertion_point(field_set:vizProtobufferMessage.VizMessage.VizSettingsPb.useSimpleLocationMarkers)
}
