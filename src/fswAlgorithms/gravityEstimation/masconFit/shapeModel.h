...
class ShapeModel {
  public:
    ...
    ShapeModel(ShapeModel&&) = delete;
    ShapeModel& operator=(ShapeModel&&) = delete;
     ...
     */
    virtual Eigen::Vector3d closestPoint(const Eigen::Vector3d& position_planetFixed) const = 0;
     ...
     * reference frame.
     */
    virtual double computeAltitude(const Eigen::Vector3d& position_planetFixed) const = 0;
    
    /** Returns the Laplacian at a position around this body.
     *
     * The position is given in the body-fixed reference frame.
     */
    virtual bool isExterior(const Eigen::Vector3d& position_planetFixed) const = 0;
